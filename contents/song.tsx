...
export const getInlineAnchor: PlasmoGetInlineAnchor = async () => document.querySelector('[aria-label="Toggle Repeat One"]')
...
const PlasmoInline = (props) => {
  ...
  const onClick = () => {
    onDownlod(element?.parentNode?.parentNode?.parentNode?.previousSibling)
  }
  return (
